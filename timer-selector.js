...
function getMessage(language, messageKey) {
  var translations = {
    ...
    'cn': {
      ...
      'template': '输出模板',
      'template-deletion': '由于本 文章/人物设定/世界设定 评分已低至了-X的低分，在此宣告将删除此页面：\n\n%%iframe%%\n\n请 文章/人物设定/世界设定 作者尽快进行修改。\n\n如果该页面作者无法及时做出更改，你可以在确定情况后向站务团队申请重写。',
      'template-ban': '网站成员[[*user USERNAME]]【违规行为】，触犯了站规【站规条目号】，对网站造成了较大的影响。\n\n所以按照站规，将对网站成员[[*user USERNAME]]进行封禁处理。\n\n%%iframe%%\n\n如果对此处理结果有疑问，可以联系网站管理员团队。\n\n本次判决允许上诉。',
    ...
    'zh': {
      ...
      'message-finished': '此计时器已過期（可選）',
      'advanced-section': '高級設置',
      'height': '高度',
      'width': '寬度',
      'css-extra': '自覺得計時器樣式（可選）',
      'template': '輸出内容模板',
      'template-deletion': '因爲本 文章/人物設定/世界設定 評分已低到-X分，故此宣告將刪除此頁面：\n\n%%iframe%%\n\n請 文章/人物設定/世界設定 的作者快速修改内容提高質量。\n\n如果該頁面作者無法及時的修改，你也可以在確認后向站務團隊申請重寫。',
      'template-ban': '網站成員[[*user USERNAME]]【違規行爲】，違反了網站站規【網站站規條目號】，對網站造成了比較大的影響。\n\n所以按照網站站規，將會對網站成員[[*user USERNAME]]進行封禁懲罰。\n\n%%iframe%%\n\n如果對此次處理結果有疑問，可以聯係網站管理團隊。\n\n本次懲罰允許上訴。',
      'message-deletion-progress': '此页面将在计时器到期后可供删除：',
      'message-deletion-finished': '此页面在下列时间可前已可供删除：',
